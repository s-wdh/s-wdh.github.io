/* 
Aufgabe 2 sind nur zwei Zeilen Code zu ändern!
Aufgabe 3 mit Algorhythmus lösen (muss erstellt werden!) siehe Liste höchste Zahl suchen
*/

/* for schleife über Array, davor variable typ number definiern. in for schelife mit if schauen, ob true und dann +1 zu var. */
...
function drawListToDOM(): void {
    ...
    for (let index: number = 0; index < tasks.length; index++) {
        ...
        //Neue Aufgabe an der Liste oben hinzufügen
...
function addTodo(): void {
    ...
    if (inputDOMElement.value != "") {
         ...
         */
        /* tasks.name.push(inputDOMElement.value);
        tasks.check.push(false); */
...
function deleteTodo(index: number): void {
    ...
    tasks.check.splice(index, 1); */ //alte Lösung
    tasks.splice(index, 1);
    /* 1 damit nur ein Wert rausgelöscht wird */
